  ...
  return {
    ...
    propulsion: {
      '0': {
        ...
        coolantTemperature: { value: state.coolantTemp },
    ...
    electrical: {
      batteries: {
        ...
        '1': { name: 'Starter Battery', capacity: { stateOfCharge: { value: state.startSoc } }, voltage: { value: state.startVoltage } },
        '2': { name: 'Thruster Battery', capacity: { stateOfCharge: { value: state.thrusterSoc } }, voltage: { value: state.thrusterVoltage } },
      },
  ...
  const delta = {
    ...
    updates: [{ timestamp: new Date().toISOString(), source: { label: 'mock', type: 'simulation' },
      values: [
        ...
        { path: 'propulsion.0.revolutions',                      value: state.rpm / 60 },
        { path: 'propulsion.0.coolantTemperature',               value: state.coolantTemp },
        { path: 'propulsion.0.oilTemperature',                   value: state.oilTemp },
        { path: 'propulsion.0.oilPressure',                      value: state.oilPressure },
        { path: 'propulsion.0.engineLoad',                       value: state.engineLoad },
        { path: 'propulsion.0.boostPressure',                    value: state.boostPressure },
        { path: 'propulsion.0.fuelRate',                         value: state.fuelRate },
        { path: 'propulsion.0.transmission.gear',                value: state.gear },
        { path: 'propulsion.0.runTime',                          value: state.engineHours * 3600 },
        { path: 'propulsion.0.alarms',                           value: computeAlarms() },
        { path: 'electrical.batteries.0.capacity.stateOfCharge', value: state.houseSoc },
        { path: 'electrical.batteries.0.voltage',                value: state.houseVoltage },
        { path: 'electrical.batteries.0.current',                value: state.houseCurrent },
        { path: 'electrical.batteries.1.capacity.stateOfCharge', value: state.startSoc },
        { path: 'electrical.batteries.1.voltage',                value: state.startVoltage },
        { path: 'electrical.batteries.2.capacity.stateOfCharge', value: state.thrusterSoc },
        { path: 'electrical.alternators.0.voltage',              value: state.alternatorVoltage },

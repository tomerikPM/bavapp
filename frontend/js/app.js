...
async function recordSensors() {
  ...
  const PATHS = [
    { path: 'electrical.batteries.0.capacity.stateOfCharge', unit: 'ratio' },
    { path: 'electrical.batteries.0.voltage',                unit: 'V' },
    { path: 'electrical.batteries.0.current',                unit: 'A' },
    { path: 'electrical.batteries.1.capacity.stateOfCharge', unit: 'ratio' },
    { path: 'electrical.batteries.2.capacity.stateOfCharge', unit: 'ratio' },
    ...
    { path: 'propulsion.0.revolutions',                      unit: 'Hz' },
    { path: 'propulsion.0.coolantTemperature',               unit: 'K' },
    { path: 'propulsion.0.runTime',                          unit: 's' },
    { path: 'propulsion.0.oilTemperature',                   unit: 'K' },
    { path: 'propulsion.0.oilPressure',                      unit: 'Pa' },
    { path: 'propulsion.0.engineLoad',                       unit: 'ratio' },
    { path: 'propulsion.0.boostPressure',                    unit: 'Pa' },
    { path: 'propulsion.0.fuelRate',                         unit: 'm3/s' },
    { path: 'electrical.alternators.0.voltage',              unit: 'V' },
